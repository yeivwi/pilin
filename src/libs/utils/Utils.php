...
class Utils implements  Listener {
	...
	public static function spawnFirework(Position $pos, $color, $type = Fireworks::TYPE_SMALL_SPHERE){
		$data = new Fireworks();
		$data->addExplosion($type, $color, $color, false, false);
		$data->setFlightDuration(0);
